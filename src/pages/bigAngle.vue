  ...
  <div class="bigAngle">
    ...
    <div class="bigAngle__right">
      <div class="right__top">
        ...
        <div class="recg__box">
          <img :src="angleImg[0].src" alt class="recg__item" />
        </div>
        <div id="WebGL-output"></div>
        <ul class="info__box" v-if="isku">
          <li class="info__item">
      ...
      <div class="right__bottom">
        ...
        <img src="../assets/img/char1.jpg" alt class="char" v-if="!btnKey&&isku"/>
        <img src="../assets/img/char2.jpg" alt="" class="char1">
  ...
  methods: {
    ...
    beforeUploadFile2(e) {
      ...
      this.angleImg = [
        {
          id: Math.floor(Math.random * 100),
          src: window.BASEURL.flieUrl +  `${startName}/${startName}_angle.jpg`
        }
      ];
    ...
    INIT(width, height, name) {
      ...
      //设置背景颜色
      VM.renderer.setClearColor(0x242f4d);
      ...
      var modelPath = window.BASEURL.flieUrl +  `${name}`;
    ...
    getModelTxt(name) {
      ...
      axios
        .get(window.BASEURL.flieUrl + `${name}/face_points_distance.txt`)
        .then(function(res) {
    ...
    getInfo(name) {
      let VM = this;
      this.$http.api
        .get(window.BASEURL.flieUrl + `${name}/${name}.json`)
        .then(function(res) {
          if (res.data.code === 0) {
